...
namespace IQToolkit.Data
{
    ...
    public class SqlFormatter : DbExpressionVisitor
    {
        ...
        protected virtual string GetAggregateName(AggregateType aggregateType)
        {
        ...
        protected virtual bool RequiresAsteriskWhenNoArgument(AggregateType aggregateType)
        {
