...
namespace IQToolkit.Data
{
    public abstract class BasicMapping : QueryMapping
    {
        ...
        public override MappingEntity GetEntity(Type elementType, string entityID, Type entityType)
        {
            return new BasicMappingEntity(elementType, entityID, entityType);
        }
        ...
        class BasicMappingEntity : MappingEntity
        {
            ...
            public BasicMappingEntity(Type elementType, string entityID, Type entityType)
            {
        ...
        /// <param name="member"></param>
        /// <returns></returns>
        protected virtual bool IsPrimaryKey(MappingEntity entity, MemberInfo member)
        {
            return false;
        }
        ...
        /// <param name="rowType"></param>
        /// <returns></returns>
        protected virtual IEnumerable<MemberInfo> GetMappedMembers(MappingEntity entity)
        {
        ...
        protected virtual Expression GetUpdateResult(MappingEntity entity, Expression instance, LambdaExpression selector)
        {
            ...
            TableAlias newAlias = new TableAlias();
            var pc = ColumnProjector.ProjectColumns(this.Language.CanBeColumn, selection, null, newAlias, tq.Select.Alias);
            return new ProjectionExpression(
