...
namespace IQToolkit.Data
{
    ...
    public abstract class QueryMapping
    {
        ...
        {
            return this.GetEntity(type, type.Name, type);
        }
        ...
        /// <returns></returns>
        public virtual MappingEntity GetEntity(Type type, string entityID)
        {
            return this.GetEntity(type, entityID, type);
        }
        ...
        /// <returns></returns>
        public abstract MappingEntity GetEntity(Type elementType, string entityID, Type entityType);
